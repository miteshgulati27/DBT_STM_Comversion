{%- macro m_audit_lel_to_edw_ytd_amt(
    in_source_schema,
    in_source_table,
    in_target_schema,
    in_target_table,
...
{#--
    Audit macro: Compares Year-To-Date amounts between LEL source and EDW target.
...
audit_result AS (
    SELECT
        ...
        CASE
            WHEN ABS(s.src_ytd_amt - t.tgt_ytd_amt) <= {{ in_tolerance }} THEN 'PASS'
            ELSE 'FAIL'
        END AS audit_status,
