/*
  ...
  'pcx_ca7specialtypeexcl' table_name
  , 'CA' LOB
  , 'EXCL' CLAUSE_TYPE
  , 'CVRBL_KEY' CVRBL_KEY_SELECTION
  , 'CA7SpecialType' CVRBL_KEY_TEXT
  , 'SpecialType' CVRBL_KEY_SRC_COL
  , 'CA7SPECIALTYPEEXCL' CLAUSE_KEY_TEXT
*/

{% set term_table_name = 'pcx_ca7specialtypeexcl' -%}
{% set lob = 'CA' -%}
...
{% set clause_key_text = 'CA7SPECIALTYPEEXCL' -%}  {# Match clause type #}
