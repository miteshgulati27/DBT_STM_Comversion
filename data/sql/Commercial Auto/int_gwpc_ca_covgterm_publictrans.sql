/*
  ...
  'pcx_ca7publictranscov' table_name
  , 'CA' LOB
  , 'COVG' CLAUSE_TYPE
  , 'CVRBL_KEY' CVRBL_KEY_SELECTION
  , 'CA7PublicTransport' CVRBL_KEY_TEXT
  , 'PublicTransport' CVRBL_KEY_SRC_COL
  , 'CA7PUBLICTRANSCOV' CLAUSE_KEY_TEXT
*/

{% set term_table_name = 'pcx_ca7publictranscov' -%}
{% set lob = 'CA' -%}
...
{% set clause_key_text = 'CA7PUBLICTRANSCOV' -%}  {# Match clause type #}
