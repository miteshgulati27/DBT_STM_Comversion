/*
  ...
  'pcx_ca7namedindcond' table_name
  , 'CA' LOB
  , 'COND' CLAUSE_TYPE
  , 'CVRBL_KEY' CVRBL_KEY_SELECTION
  , 'CA7NamedInd' CVRBL_KEY_TEXT
  , 'NamedInd' CVRBL_KEY_SRC_COL
  , 'CA7NAMEDINDCOND' CLAUSE_KEY_TEXT
*/

{% set term_table_name = 'pcx_ca7namedindcond' -%}
{% set lob = 'CA' -%}
...
{% set clause_key_text = 'CA7NAMEDINDCOND' -%}  {# Match clause type #}
